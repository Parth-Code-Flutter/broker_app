      ...
      if (_controller.position.atEdge) {
        ...
        if (isTop) {
          ...
          if (context.read<ContractsProvider>().isListEmpty == false) {
            // setState(() {});
            await context.read<ContractsProvider>().setContractsData(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: AppText(
                                            text:
                                                '${(contractData.vouType ?? '').trim()}-${contractData.contractVno ?? 0}',
                                            style: AppTextStyles
                                                .tinyListTextStyle
                                                .copyWith(
                                                    fontWeight:
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: AppText(
                                        text:
                                            '${returnCityState(contractData.sellerCityName ?? '', contractData.sellerStateName ?? '')}',
                                        style: AppTextStyles.tinyListTextStyle,
                                        maxLines: 2,
                                      ),
                                    ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: AppText(
                                        text:
                                            // ': ${contractData.buyerCityName ?? ''}',
                                            '${returnCityState(contractData.buyerCityName ?? '', contractData.buyerStateName ?? '')}',
                                        style: AppTextStyles.tinyListTextStyle,
                                        maxLines: 2,
                                      ),
                                    ),
