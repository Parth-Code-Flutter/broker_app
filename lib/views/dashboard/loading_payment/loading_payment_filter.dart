...
import 'package:broker_app/views/dashboard/loading_payment/loading_payment_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:provider/provider.dart';

class LoadingPaymentFilter extends StatefulWidget {
  const LoadingPaymentFilter({super.key});

  @override
  State<LoadingPaymentFilter> createState() => _LoadingPaymentFilterState();
}

class _LoadingPaymentFilterState extends State<LoadingPaymentFilter> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      appBar:
          appBar(title: '$kLoadingPayment $kFilter', isShowBackButton: true),
      body: InkWell(
        onTap: () {
        ...
        children: [
          AppText(
            ...
            style: AppTextStyles.textFieldText.copyWith(
                color: AppColors.blackShade, fontWeight: FontWeight.w500),
          ),
          AppSpaces.v4,
          Row(
            children: [
              GestureDetector(
                ...
                child: Row(
                  children: [
                    pendingStatusValue == 0
                        ? SvgPicture.asset(AppAssets.checkedIcon)
                        : SvgPicture.asset(AppAssets.uncheckedIcon),
                    AppSpaces.h10,
                    AppText(
                      text: kYes,
